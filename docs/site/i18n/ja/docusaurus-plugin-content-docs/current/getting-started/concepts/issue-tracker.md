...
projects、issues、comments、attachment metadata、summary data を SQLite に保存します。
...
各 issue は project、title、description、status、priority、optional assignee、
timestamps、comments、optional image attachments を持ちます。Markdown descriptions と
comments は `attachment://<id>` URLs で uploaded images を参照できます。
