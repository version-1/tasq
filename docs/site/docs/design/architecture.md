...
For Web UI structure and styling conventions, see the source repository document at [docs/design/web.md](https://github.com/version-1/tasq/blob/main/docs/design/web.md).
