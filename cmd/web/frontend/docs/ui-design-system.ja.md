...
- issue description と Markdown 入力 form field のために、共有 Markdown
  renderer を read/edit mode で包む component。
- Read mode は通常の Markdown 表示を維持し、header に compact な pencil
  icon action を表示できます。
