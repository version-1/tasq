...
このドキュメントでは user-facing な issue-tracker API を扱います。所有境界と component responsibility は [architecture.md](architecture.md) を参照してください。local development と verification は [operations.md](operations.md) を参照してください。
